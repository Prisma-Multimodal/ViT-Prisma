...
import vit_prisma.vjepa_hf.src.models.vision_transformer as vit
from vit_prisma.vjepa_hf.src.models.attentive_pooler import AttentiveClassifier
from vit_prisma.vjepa_hf.src.datasets.data_manager import (
    init_data,
)
from vit_prisma.vjepa_hf.src.utils.cluster import get_dataset_path
from vit_prisma.vjepa_hf.src.utils.distributed import (
    init_distributed,
    AllReduce
)
from vit_prisma.vjepa_hf.src.utils.schedulers import (
    WarmupCosineSchedule,
    CosineWDSchedule,
)
from vit_prisma.vjepa_hf.src.utils.logging import (
    AverageMeter,
    CSVLogger
)
...
def main(args_eval, resume_preempt=False):
    ...
    num_probe_blocks = args_eval.get('num_probe_blocks', 1)
